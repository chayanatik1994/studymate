      ...
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between gap-12 px-6">
        ...
        <div className="flex flex-col md:flex-1 gap-4">
          ...
          <p className="text-sm text-gray-300">
            StudyMate is platform connecting students for effective learning collaboration.
          </p>
          <div className="flex gap-4 mt-3">
            <a href="https://facebook.com" target="_blank" rel="noopener noreferrer" className="hover:text-blue-600">Facebook</a>
            <a href="https://x.com" target="_blank" rel="noopener noreferrer" className="hover:text-blue-400">X</a>
